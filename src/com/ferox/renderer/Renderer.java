 ...
 * specifics of a scene: 1. Resource - fairly static data stored on the graphics
 * card. 2. Geometry - describes the shape of something to be rendered (it's
 * also a Resource). 3. Effect - modifies how the Geometry is rendered (e.g.
 * surface description).
 * 
 ...
 * UNDER NO CIRCUMSTANCES SHOULD THESE METHODS BE CALLED OR USED EXTERNALLY TO
 * RENDERER IMPLS.
 * 
...
public interface Renderer {
	 ...
	 * 
	 * If ERROR is returned, the resource will be ignored.
	 * 
