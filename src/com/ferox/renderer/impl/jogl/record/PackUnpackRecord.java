...
/** This represents the part of the PixelRecord pertaining
 * to packing and unpacking blocks of pixel data.  The rest
 * of the pixel record is not included because it's unlikely
 * to be used, and much of it is color convolution.
 * 
