...
public class DDSTexture {
	...
	/**
	 * Read in and create a new TextureImage from the given stream. This image
	...
	public static TextureImage readTexture(InputStream stream)
		...
		case T_2D:
			return new Texture2D(texture.data[0], texture.width,
							texture.height, texture.format, texture.type);
		case T_3D:
			return new Texture3D(texture.data[0], texture.width,
							texture.height, texture.depth, texture.format,
							texture.type);
		case T_CUBEMAP:
			return new TextureCubeMap(texture.data[0], texture.data[2],
							texture.data[4], texture.data[1], texture.data[3],
							texture.data[5], texture.width, texture.format,
							texture.type);
		default:
			throw new IOException("Unsupported texture target type: "
							+ texture.target);
		}
	}
		...
		public String toString() {
			...
			if (isFlagSet(flags, DDPF_FOURCC)) {
				...
				second = "Total bits = " + rgbBitCount + ", has alpha = "
								+ isFlagSet(flags, DDPF_ALPHAPIXELS)
								+ " Bit masks: r/l = "
	...
	private static enum DXGIPixelFormat {
		DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_R32G32B32A32_TYPELESS, DXGI_FORMAT_R32G32B32A32_FLOAT(
						DataType.FLOAT, TextureFormat.RGBA_FLOAT), DXGI_FORMAT_R32G32B32A32_UINT, DXGI_FORMAT_R32G32B32A32_SINT, DXGI_FORMAT_R32G32B32_TYPELESS, DXGI_FORMAT_R32G32B32_FLOAT(
						DataType.FLOAT, TextureFormat.RGB_FLOAT), DXGI_FORMAT_R32G32B32_UINT, DXGI_FORMAT_R32G32B32_SINT, DXGI_FORMAT_R16G16B16A16_TYPELESS, DXGI_FORMAT_R16G16B16A16_FLOAT, DXGI_FORMAT_R16G16B16A16_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.RGBA), DXGI_FORMAT_R16G16B16A16_UINT, DXGI_FORMAT_R16G16B16A16_SNORM, DXGI_FORMAT_R16G16B16A16_SINT, DXGI_FORMAT_R32G32_TYPELESS, DXGI_FORMAT_R32G32_FLOAT(
						DataType.FLOAT, TextureFormat.LUMINANCE_ALPHA_FLOAT), DXGI_FORMAT_R32G32_UINT, DXGI_FORMAT_R32G32_SINT, DXGI_FORMAT_R32G8X24_TYPELESS, DXGI_FORMAT_D32_FLOAT_S8X24_UINT, DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS, DXGI_FORMAT_X32_TYPELESS_G8X24_UINT, DXGI_FORMAT_R10G10B10A2_TYPELESS, DXGI_FORMAT_R10G10B10A2_UNORM, DXGI_FORMAT_R10G10B10A2_UINT, DXGI_FORMAT_R11G11B10_FLOAT, DXGI_FORMAT_R8G8B8A8_TYPELESS, DXGI_FORMAT_R8G8B8A8_UNORM(
						DataType.UNSIGNED_INT, TextureFormat.RGBA_8888), DXGI_FORMAT_R8G8B8A8_UNORM_SRGB(
						DataType.UNSIGNED_INT, TextureFormat.RGBA_8888), DXGI_FORMAT_R8G8B8A8_UINT, DXGI_FORMAT_R8G8B8A8_SNORM, DXGI_FORMAT_R8G8B8A8_SINT, DXGI_FORMAT_R16G16_TYPELESS, DXGI_FORMAT_R16G16_FLOAT, DXGI_FORMAT_R16G16_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.LUMINANCE_ALPHA), DXGI_FORMAT_R16G16_UINT, DXGI_FORMAT_R16G16_SNORM, DXGI_FORMAT_R16G16_SINT, DXGI_FORMAT_R32_TYPELESS, DXGI_FORMAT_D32_FLOAT(
						DataType.FLOAT, TextureFormat.DEPTH), DXGI_FORMAT_R32_FLOAT(
						DataType.FLOAT, TextureFormat.LUMINANCE_FLOAT), // not
		// the
		// best
		// mapping,
		// but
		// it
		// works
		DXGI_FORMAT_R32_UINT, DXGI_FORMAT_R32_SINT, DXGI_FORMAT_R24G8_TYPELESS, DXGI_FORMAT_D24_UNORM_S8_UINT, DXGI_FORMAT_R24_UNORM_X8_TYPELESS, DXGI_FORMAT_X24_TYPELESS_G8_UINT, DXGI_FORMAT_R8G8_TYPELESS, DXGI_FORMAT_R8G8_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.LUMINANCE_ALPHA), // not
		// the
		// best
		// mapping,
		// but
		// it
		// works
		DXGI_FORMAT_R8G8_UINT, DXGI_FORMAT_R8G8_SNORM, DXGI_FORMAT_R8G8_SINT, DXGI_FORMAT_R16_TYPELESS, DXGI_FORMAT_R16_FLOAT, DXGI_FORMAT_D16_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.DEPTH), DXGI_FORMAT_R16_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.LUMINANCE), DXGI_FORMAT_R16_UINT, DXGI_FORMAT_R16_SNORM, DXGI_FORMAT_R16_SINT, DXGI_FORMAT_R8_TYPELESS, DXGI_FORMAT_R8_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.LUMINANCE), DXGI_FORMAT_R8_UINT, DXGI_FORMAT_R8_SNORM, DXGI_FORMAT_R8_SINT, DXGI_FORMAT_A8_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.ALPHA), DXGI_FORMAT_R1_UNORM, DXGI_FORMAT_R9G9B9E5_SHAREDEXP, DXGI_FORMAT_R8G8_B8G8_UNORM, DXGI_FORMAT_G8R8_G8B8_UNORM, DXGI_FORMAT_BC1_TYPELESS, DXGI_FORMAT_BC1_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.RGB_DXT1), DXGI_FORMAT_BC1_UNORM_SRGB(
						DataType.UNSIGNED_BYTE, TextureFormat.RGBA_DXT1), DXGI_FORMAT_BC2_TYPELESS, DXGI_FORMAT_BC2_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.RGBA_DXT3), DXGI_FORMAT_BC2_UNORM_SRGB(
						DataType.UNSIGNED_BYTE, TextureFormat.RGBA_DXT3), DXGI_FORMAT_BC3_TYPELESS, DXGI_FORMAT_BC3_UNORM(
						DataType.UNSIGNED_BYTE, TextureFormat.RGBA_DXT5), DXGI_FORMAT_BC3_UNORM_SRGB(
						DataType.UNSIGNED_BYTE, TextureFormat.RGBA_DXT5), DXGI_FORMAT_BC4_TYPELESS, DXGI_FORMAT_BC4_UNORM, DXGI_FORMAT_BC4_SNORM, DXGI_FORMAT_BC5_TYPELESS, DXGI_FORMAT_BC5_UNORM, DXGI_FORMAT_BC5_SNORM, DXGI_FORMAT_B5G6R5_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.BGR_565), DXGI_FORMAT_B5G5R5A1_UNORM(
						DataType.UNSIGNED_SHORT, TextureFormat.BGRA_5551), DXGI_FORMAT_B8G8R8A8_UNORM(
						DataType.UNSIGNED_INT, TextureFormat.BGRA_8888), DXGI_FORMAT_B8G8R8X8_UNORM;
	...
	private static class DDPFMap {
		...
		public DDPFMap(int bitCount, int rMask, int gMask, int bMask,
						int aMask, DataType type, TextureFormat format) {
		...
		public boolean equals(DDSPixelFormat pf) {
			return this.equals(pf.rgbBitCount, pf.rBitMask, pf.gBitMask,
							pf.bBitMask, pf.rgbAlphaBitMask);
		}

		public boolean equals(int bitCount, int rMask, int gMask, int bMask,
						int aMask) {
	...
	private static final DDPFMap[] pfRGB = new DDPFMap[] {
					new DDPFMap(24, 0xff0000, 0xff00, 0xff, 0,
									DataType.UNSIGNED_BYTE, TextureFormat.RGB),
					new DDPFMap(24, 0xff, 0xff00, 0xff0000, 0,
									DataType.UNSIGNED_BYTE, TextureFormat.BGR),
					new DDPFMap(16, 0xf800, 0x7e0, 0x1f, 0,
									DataType.UNSIGNED_BYTE,
									TextureFormat.RGB_565),
					new DDPFMap(16, 0x1f, 0x7e0, 0xf800, 0,
									DataType.UNSIGNED_BYTE,
									TextureFormat.BGR_565), };

	// Supported RGBA types
	private static final DDPFMap[] pfRGBA = new DDPFMap[] {
					new DDPFMap(32, 0xff0000, 0xff00, 0xff, 0xff000000,
									DataType.UNSIGNED_INT,
									TextureFormat.ARGB_8888),
					new DDPFMap(32, 0xff000000, 0xff0000, 0xff00, 0x000000ff,
									DataType.UNSIGNED_INT,
									TextureFormat.RGBA_8888),
					new DDPFMap(32, 0xff, 0xff00, 0xff0000, 0xff000000,
									DataType.UNSIGNED_INT,
									TextureFormat.ABGR_8888),
					new DDPFMap(32, 0xff00, 0xff0000, 0xff000000, 0xff,
									DataType.UNSIGNED_INT,
									TextureFormat.BGRA_8888), };

	// Supported Luminance types
	private static final DDPFMap[] pfL = new DDPFMap[] { new DDPFMap(8, 0xff,
					0, 0, 0, DataType.UNSIGNED_BYTE, TextureFormat.LUMINANCE) };

	// Supported Luminance/Alpha types
	private static final DDPFMap[] pfLA = new DDPFMap[] { new DDPFMap(16, 0xff,
					0, 0, 0xff00, DataType.UNSIGNED_BYTE,
					TextureFormat.LUMINANCE_ALPHA) };

	// Supported Alpha types
	private static final DDPFMap[] pfA = new DDPFMap[] { new DDPFMap(8, 0, 0,
					0, 0xff, DataType.UNSIGNED_BYTE, TextureFormat.ALPHA) };
	...
	private void identifyBuildParams() throws IOException {
		if (!isFlagSet(header.flags, DDSD_CAPS)) {
			throw new IOException(
							"DDS header is missing required flag DDSD_CAPS");
		}
		...
		if (isFlagSet(header.flags, DDSD_WIDTH)) {
			...
			throw new IOException(
							"DDS header is missing required flag DDSD_WIDTH");
		}
		...
		if (isFlagSet(header.flags, DDSD_HEIGHT)) {
			...
			throw new IOException(
							"DDS header is missing required flag DDSD_HEIGHT");
		}
		...
		if (isFlagSet(header.caps2, DDSCAPS2_VOLUME)) {
			target = TextureTarget.T_3D;
		} else if (isFlagSet(header.caps2, DDSCAPS2_CUBEMAP)) {
			target = TextureTarget.T_CUBEMAP;
		} else {
			target = TextureTarget.T_2D;
		}

		depth = 1;
		// further validate the dimensions
		if (target == TextureTarget.T_3D) {
			...
			if (target == TextureTarget.T_2D) {
				...
				if (header.headerDX10.resourceDimension == D3D10_RESOURCE_DIMENSION_TEXTURE2D) {
					...
					if (header.headerDX10.arraySize != 6) {
						throw new IOException(
										"Cube map must have 6 faces present");
					}
				} else {
					throw new IOException(
									"DX10 header and surface caps are inconsistent");
		...
		if (isFlagSet(header.flags, DDSD_MIPMAPCOUNT)) {
			...
			int expected = (int) (Math.log(Math.max(width, Math.max(height,
							depth)))
							/ Math.log(2) + 1);
			if (mipmapCount != expected) {
				throw new IOException("Expected " + expected + " but got "
								+ mipmapCount + " mipmaps instead");
			}
		} else {
			mipmapCount = 1;
		}
	...
	private void identifyTextureFormat() throws IOException {
		...
		if (header.headerDX10 != null) {
			...
			if (!header.headerDX10.dxgiFormat.supported) {
				throw new IOException("Unsupported dxgi pixel format: "
								+ header.headerDX10.dxgiFormat);
			} else {
				format = header.headerDX10.dxgiFormat.format;
				type = header.headerDX10.dxgiFormat.type;
			}
		} else {
			if (isFlagSet(header.pixelFormat.flags, DDPF_FOURCC)) {
				// interpret the FOURCC flag. Currently only supports DXT1,
				// DXT3, and DXT5
				...
				if (header.pixelFormat.fourCC == FOURCC_DXT1) {
					...
					throw new IOException(
									"Unrecognized fourCC value in pixel format: "
		...
		if (format.getPrimitivesPerColor() < 0 && target == TextureTarget.T_3D) {
			throw new IOException(
	...
	private static DDSHeader readHeader(InputStream in) throws IOException {
		...
		if (h.pixelFormat.fourCC == FOURCC_DX10) { // According to AMD, this is
			...
			h.headerDX10.dxgiFormat = (dxgi < 0
							|| dxgi >= DXGIPixelFormat.values().length ? DXGIPixelFormat
							.values()[0]
	...
	private void readData(InputStream in) throws IOException {
		...
		int arrayCount = 1;
		if (target == TextureTarget.T_CUBEMAP) {
		...
		for (int i = 0; i < arrayCount; i++) {
			...
			for (int m = 0; m < mipmapCount; m++) {
				size = format.getBufferSize(width, height, depth)
								* type.getByteSize();
	...
	private BufferData createBuffer(byte[] image) throws IOException {
		...
		case UNSIGNED_INT: {
			...
			return new BufferData(data, true);
		}
		case UNSIGNED_SHORT: {
		...
		case FLOAT: {
			float[] data = new float[image.length / 2];
			for (int i = 0; i < data.length; i++) {
				data[i] = bytesToFloat(image, i << 2);
			}
			return new BufferData(data, false);
		}
		case UNSIGNED_BYTE: {
			return new BufferData(image, true);
		}
		}
		throw new IOException("Unsupported opengl texture data type: " + type);
	}
	...
	private static int makeFourCC(String c) {
		...
		return ((cc[3] & 0xff) << 24) | ((cc[2] & 0xff) << 16)
						| ((cc[1] & 0xff) << 8) | ((cc[0] & 0xff) << 0);
	}
