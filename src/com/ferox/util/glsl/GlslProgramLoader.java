...
/**
 * This is a very simple utility that loads a GlslProgram from two input text
...
public class GlslProgramLoader {
	 ...
	 * text as its vertex and fragment shaders. If vertexShader is null, then no
	...
	/*
	 * Utility to read all lines of a file and convert it to an array of
	 * strings.
	 */
