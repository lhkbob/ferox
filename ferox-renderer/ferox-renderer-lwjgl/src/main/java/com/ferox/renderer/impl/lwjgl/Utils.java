...
public class Utils {
     ...
     */
	public static void get(Color3f color, FloatBuffer buffer) {
		buffer.put(0, color.getRed());
		buffer.put(1, color.getGreen());
		buffer.put(2, color.getBlue());
		buffer.put(3, color.getAlpha());
	}
	
	/**
	 * Store vec into the 3-element float buffer
	 */
	public static void get(Vector3f vec, FloatBuffer b) {
	    b.put(0, vec.x);
	    b.put(1, vec.y);
	    b.put(2, vec.z);
	}
	...
	/**
     * Store vec into the 4-element float buffer
     */
    public static void get(Vector4f vec, FloatBuffer b) {
        b.put(0, vec.x);
        b.put(1, vec.y);
        b.put(2, vec.z);
        b.put(3, vec.w);
	 ...
	 * color.
	 */
	public static boolean equals(Color3f color, FloatBuffer buffer) {
		return color.getRed() == buffer.get(0) && 
			   color.getGreen() == buffer.get(1) && 
			   color.getBlue() == buffer.get(2) && 
			   color.getAlpha() == buffer.get(3);
	}
