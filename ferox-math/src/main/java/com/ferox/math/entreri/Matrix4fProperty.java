...
/**
 * Matrix4fProperty is a caching property that wraps a FloatProperty
 * as a ReadOnlyMatrix4f, but also provides a setter so it can be
 * mutated.
...
public class Matrix4fProperty implements CompactAwareProperty {
     ...
     * transferred from the underlying FloatProperty into a cached Matrix4f
