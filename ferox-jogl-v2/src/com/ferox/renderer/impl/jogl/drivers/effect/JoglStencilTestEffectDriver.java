 ...
 */
public class JoglStencilTestEffectDriver extends SingleEffectDriver<StencilTest, GL2ES2> {
	...
	@Override
	protected void apply(GL2ES2 gl, JoglStateRecord record, StencilTest nextState) {
