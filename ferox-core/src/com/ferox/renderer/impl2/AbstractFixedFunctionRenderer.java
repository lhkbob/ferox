...
public abstract class AbstractFixedFunctionRenderer extends AbstractRenderer implements FixedFunctionRenderer {
    ...
    protected static class LightState {
        ...
        public final Color3f ambient = new Color3f(0f, 0f, 0f, 1f);
        public final Color3f specular = new Color3f(0f, 0f, 0f, 1f);
        public final Color3f diffuse = new Color3f(0f, 0f, 0f, 1f);
    ...
    protected static class TextureState {
        ...
        public Color3f color = new Color3f(0f, 0f, 0f, 0f);
    ...
    // cached defaults
    private static final Color3f DEFAULT_MAT_A_COLOR = new Color3f(.2f, .2f, .2f, 1f);
    private static final Color3f DEFAULT_MAT_D_COLOR = new Color3f(.8f, .8f, .8f, 1f);
    
    private static final Color3f ZERO = new Color3f(0f, 0f, 0f, 0f);
    private static final Color3f BLACK = new Color3f(0f, 0f, 0f, 1f);
    private static final Color3f WHITE = new Color3f(1f, 1f, 1f, 1f);
    ...
    // fog
    protected final Color3f fogColor = new Color3f(ZERO);
    ...
    // global lighting
    protected final Color3f globalAmbient = new Color3f(DEFAULT_MAT_A_COLOR);
    ...
    // material
    protected final Color3f matDiffuse = new Color3f(DEFAULT_MAT_D_COLOR);
    protected final Color3f matAmbient = new Color3f(DEFAULT_MAT_A_COLOR);
    protected final Color3f matSpecular = new Color3f(BLACK);
    protected final Color3f matEmmissive = new Color3f(BLACK);
     ...
     */
    protected abstract void glFogColor(Color3f color);
    ...
    @Override
    public void setGlobalAmbientLight(Color3f ambient) {
        if (ambient == null)
     ...
     */
    protected abstract void glGlobalLighting(Color3f ambient);
    
    @Override
    public void setLightColor(int light, Color3f amb, Color3f diff, Color3f spec) {
     ...
     */
    protected abstract void glLightColor(int light, LightColor lc, Color3f color);
    ...
    @Override
    public void setMaterial(Color3f amb, Color3f diff, Color3f spec, Color3f emm) {
     ...
     */
    protected abstract void glMaterialColor(LightColor component, Color3f color);
    ...
    @Override
    public void setTextureColor(int tex, Color3f color) {
        if (tex < 0 || tex >= textures.length)
            return; // ignore it
        if (color == null)
     ...
     */
    protected abstract void glTextureColor(Color3f color);
