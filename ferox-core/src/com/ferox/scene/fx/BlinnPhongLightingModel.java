...
public class BlinnPhongLightingModel extends Component {
	private static final String DESCR = "Renderable Entities are lit using the Blinn-Phong lighting model";
